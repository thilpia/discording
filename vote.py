import discord # 봇을 만들기 위해 디스코드 모듈을 불러옵니다.
from random import *
import random
...
class bot(discord.Client):
    ...
    async def on_message(self, message):
        ...
        if message.content == "7녜힁": 
            ...
            rws = random.choice(msgs)
            rts = random.choice(msgs)
            rps = random.choice(msgs)
            ris = res+ras+rus+rns+rws+rts+rps
            await message.channel.send(ris)

        if message.content == "8녜힁": 
            res = random.choice(msgs) 
            ras = random.choice(msgs)
            rus = random.choice(msgs)
            rns = random.choice(msgs)
            ...
            rts = random.choice(msgs)
            rps = random.choice(msgs)
            rys = random.choice(msgs)
            ris = res+ras+rus+rns+rws+rts+rps+rys
            await message.channel.send(ris)

        if message.content == "9녜힁": 
            res = random.choice(msgs) 
            ras = random.choice(msgs)
            rus = random.choice(msgs)
            rns = random.choice(msgs)
            ...
            rps = random.choice(msgs)
            rys = random.choice(msgs)
            rgs = random.choice(msgs)
            ris = res+ras+rus+rns+rws+rts+rps+rys+rgs
            await message.channel.send(ris)

        if message.content == "10녜힁": 
            res = random.choice(msgs) 
            ras = random.choice(msgs)
            rus = random.choice(msgs)
            rns = random.choice(msgs)
            ...
            rys = random.choice(msgs)
            rgs = random.choice(msgs)
            ros = random.choice(msgs)
            ris = res+ras+rus+rns+rws+rts+rps+rys+rgs+ros
            await message.channel.send(ris)

        if message.content == "20녜힁": 
                res = random.choice(msgs) 
                ras = random.choice(msgs)
                rus = random.choice(msgs)
                rns = random.choice(msgs)
                ...
                rgs = random.choice(msgs)
                ros = random.choice(msgs)
                tes = random.choice(msgs)
                tos = random.choice(msgs)
                tas = random.choice(msgs)
                tis = random.choice(msgs)
                tus = random.choice(msgs)
                tns = random.choice(msgs)
                tws = random.choice(msgs)
                tms = random.choice(msgs)
                tls = random.choice(msgs)
                tys = random.choice(msgs)
                ris = res+ras+rus+rns+rws+rts+rps+rys+rgs+ros+tes+tos+tas+tis+tus+tns+tws+tms+tls+tys
                await message.channel.send("```fix\n"+ris+"\n```")
                                     

        if message.content == "랜덤녜힁": 
            date = randint(0,10)
            if date == 0:
                res = random.choice(msgs) 
                ris = res
